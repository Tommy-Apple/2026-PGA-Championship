...
function Scoreboard({ draftState }) {
  ...
  return (
    <div>
      ...
      <div style={sb.grid}>
        {sorted.map((team, i) => (
          <div key={team.id} style={{ ...sb.card, ...(i === 0 && team.teamScore !== null ? sb.cardFirst : {}), ...(team.name === "Tommy Applebaum" ? sb.cardYou : {}) }}>
            <div style={sb.cardHeader}>
              <div style={sb.rank}>{i === 0 && team.teamScore !== null ? "🏆" : i === 1 ? "🥈" : i === 2 ? "🥉" : `#${i + 1}`}</div>
